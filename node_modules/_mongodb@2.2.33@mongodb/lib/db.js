 ...
 * @param {string} [options.viewOn=null] The name of the source collection or views from which to create the views. The name is not the full namespace of the collection or views; i.e. does not include the database name and implies the same database as the views to create on MongoDB 3.4 or higher.
 * @param {array} [options.pipeline=null] An array that consists of the aggregation pipeline stage. create creates the views by applying the specified pipeline to the viewOn collection or views on MongoDB 3.4 or higher.
